...
def start(start=None):
    ...
    results = session.query(func.min(Measurement.tobs), func.avg(Measurement.tobs), func.max(Measurement.tobs)).filter(Measurement.date.between(start, latest_date)).all()
    temp_data = []
